...
| `persistentVolumeClaimWaitUntilBound`      | controls wait_until_bound in the terraform PVC. Useful when running in environments where PVC binding is set as WaitForFirstConsumer in an managed Kubernetes system such as SAP BTP Kyma.                                                                              | `true`                        |
